...
def visualize_and_get_centroids(frame, detection_result):
    """Draws bounding boxes on the frame and calculates centroids of detected objects."""
    centroids = []
    ...
    for detection in detection_result.detections:
        ...
        frame = cv2.circle(frame, (centroid_x, centroid_y), 5, (0, 0, 255), -1)  # Red color for centroid
